...
test_cases = [
        ...
        "elite_mods": [
            {
                "targets": ["ALL"],
                "mods": [
                    {"key": "atk", "mode": "mul", "value": 1.3},
                    {"key": "def", "mode": "mul", "value": 1.2},
                    {"key": "hp", "mode": "mul", "value": 1.3},
                ],
            },
            {
                "targets": ["enemy_1103_wdkght", "enemy_1103_wdkght_2"],
                "special": {
                    "stealth": {
                        "tooltip": {
                            "en": ["$Stealth$"],
    ...
    },
    {
        ...
        "all_mods": [
            {
                "targets": ["trap_096_gflag"],
                "mods": [{"key": "hp", "mode": "add", "value": 10000.0}],
            }
        ],
        "elite_mods": [
            {
                "targets": ["ALL"],
                "mods": [
                    {"key": "atk", "mode": "mul", "value": 1.1},
                    {"key": "def", "mode": "mul", "value": 1.2},
                    {"key": "hp", "mode": "mul", "value": 1.5},
                ],
            },
            {
        ...
        "all_mods": [
            {
                "targets": ["ALL"],
                "mods": [
                    {"key": "atk", "value": 1.2, "mode": "mul"},
                    {"key": "def", "value": 1.2, "mode": "mul"},
                    {"key": "hp", "value": 1.2, "mode": "mul"},
                ],
            }
        ],
        "elite_mods": None,
    ...
    },
    {
        ...
        "elite_mods": [
            ...
            {
                "targets": ["ALL"],
                "mods": [{"key": "weight", "value": 1, "mode": "add"}],
            },
        ],
        "normal_mods": None,
    },
