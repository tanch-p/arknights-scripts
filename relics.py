...
cn_roguelike_topic_path = os.path.join(
    BASE_DIR, "zh_CN\\gamedata\\excel\\roguelike_topic_table.json"
)
en_roguelike_topic_path = os.path.join(
    BASE_DIR, "en_US\\gamedata\\excel\\roguelike_topic_table.json"
)
jp_roguelike_topic_path = os.path.join(
    BASE_DIR, "ja_JP\\gamedata\\excel\\roguelike_topic_table.json"
)
...
rogue_2_relics = [
    "rogue_2_relic_fight_1",
    "rogue_2_relic_fight_2",
    "rogue_2_relic_fight_3",
    "rogue_2_relic_fight_4",
    "rogue_2_relic_fight_5",
    "rogue_2_relic_fight_6",
    "rogue_2_relic_fight_7",
    "rogue_2_relic_fight_8",
    "rogue_2_relic_fight_9",
    "rogue_2_relic_fight_42",
    "rogue_2_relic_fight_105",
    "rogue_2_relic_fight_117",
    "rogue_2_relic_fight_123",
    "rogue_2_relic_curse_2",
...
for id in rogue_1_relics:
    ...
    relic_info = {
        ...
        "effects": [],
        "tooltip_zh": cn_roguelike_topic_table["details"]["rogue_1"]["items"][id][
            "usage"
        ],
        "tooltip_ja": jp_roguelike_topic_table["details"]["rogue_1"]["items"][id][
            "usage"
        ],
        "tooltip_en": en_roguelike_topic_table["details"]["rogue_1"]["items"][id][
            "usage"
        ],
    }
...
for id in rogue_2_relics:
    ...
    relic_info = {
        "id": id,
        "name_zh": cn_roguelike_topic_table["details"]["rogue_2"]["items"][id]["name"],
        "name_ja": jp_roguelike_topic_table["details"]["rogue_2"]["items"][id]["name"]
        if "rogue_2" in jp_roguelike_topic_table["details"]
        else None,
        "name_en": en_roguelike_topic_table["details"]["rogue_2"]["items"][id]["name"]
        if "rogue_2" in jp_roguelike_topic_table["details"]
        else None,
        "img": cn_roguelike_topic_table["details"]["rogue_2"]["items"][id]["name"],
        "effects": [],
        "tooltip_zh": cn_roguelike_topic_table["details"]["rogue_2"]["items"][id][
            "usage"
        ],
        "tooltip_ja": jp_roguelike_topic_table["details"]["rogue_2"]["items"][id][
            "usage"
        ]
        if "rogue_2" in jp_roguelike_topic_table["details"]
        else None,
        "tooltip_en": en_roguelike_topic_table["details"]["rogue_2"]["items"][id][
            "usage"
        ]
        if "rogue_2" in jp_roguelike_topic_table["details"]
        else None,
